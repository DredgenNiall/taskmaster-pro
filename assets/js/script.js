...
$(".list-group").on("blur", "textarea", function(){
  ...
  //get the task's position in the list of other li elemenets
  var index = $(this)
  .closest(".list-group-item")
  .index();
...
//add sortable drag and drop jquery
...
//add date picker to creating task UI elements
